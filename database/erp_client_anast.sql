...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2026 at 02:43 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `check_feature_enabled` (IN `p_feature_slug` VARCHAR(255))   BEGIN
    SELECT is_enabled FROM vendor_features 
    WHERE feature_slug = p_feature_slug AND is_enabled = 1
    LIMIT 1;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `check_subcategory_enabled` (IN `p_feature_id` INT(11) UNSIGNED, IN `p_subcategory_slug` VARCHAR(255))   BEGIN
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `is_feature_enabled` (`p_feature_slug` VARCHAR(255)) RETURNS TINYINT(1) DETERMINISTIC READS SQL DATA BEGIN
...
(6, 9, 21, 17, 4, NULL, 1, 0, 1, 'active', '2026-01-01 13:53:36', '2026-01-01 13:59:28');
...
(20, 9, 6, 21, 17, 4, NULL, 'textbook', 'Guide', 0.00, 0.00, 0.00, NULL, 150.00, 'mandatory+optional', NULL, 0, 0, 1, 'active', 1, '2026-01-01 13:59:28', '2026-01-01 13:59:28');
...
(14, 20, 'textbook', 2, 'R D SHARMA MATHS VOL 1 AND 2 CL 12', 1, 1000000.00, 'mandatory', 0.00, NULL, 'active', '2026-01-01 13:59:28', '2026-01-01 13:59:28');
...
(21, 9, 'testtt', '17', 100, 'testt', '474', 'testt', 101, 1548, 14723, '400075', 'siltt', '9876543210', 'siltt@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'active', 0, NULL, 0, 0, '2026-01-01 16:54:55', '2026-01-01 16:54:55'),
(22, 9, 'City International School', '17', 500, 'City International School', 'ICSE/347/74123', 'Oshiwara', 101, 1568, 17423, '400105', 'siltt', '9876543210', 'siltt@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'active', 0, NULL, 0, 0, '2026-01-02 16:19:33', '2026-01-02 16:19:33');
...
(17, 9, 'ICSE', '', 'active', '2026-01-01 16:34:17', '2026-01-01 16:34:17'),
(18, 9, 'CBSE', '', 'active', '2026-01-01 18:12:07', '2026-01-01 18:12:07');
...
(57, 21, 17, '2026-01-01 16:54:55'),
(58, 22, 17, '2026-01-02 16:19:33');
...
(2, 22, 9, 'Pune', 'Pune', 101, 1568, 17479, '400135', 'active', '2026-01-02 16:25:21', '2026-01-02 16:25:21'),
(3, 22, 9, 'Gujarat Branch', 'Gujarat', 101, 1558, 15517, '400304', 'active', '2026-01-02 16:29:42', '2026-01-02 16:29:42');
...
(1, 21, 'school_21_1767266695_0.png', 'about-content-2.png', 0, 1, '2026-01-01 16:54:55'),
(2, 22, 'school_22_1767350973_0.jpeg', '66dfe24f2e42f9-20964353-51202494.jpeg', 0, 1, '2026-01-02 16:19:33');
...
(2, 9, 3, 18, 'grade', 'R D SHARMA MATHS VOL 1 AND 2 CL 12', 'CL-12', 1, 7, '<p>R D SHARMA MATHS VOL 1 AND 2 CL 12</p>\r\n', '<p>R D SHARMA MATHS VOL 1 AND 2 CL 12</p>\r\n', 1.00, 1.00, 1.00, 1.00, 5.00, NULL, '74123', 'CL12', '74123', 700.00, 1400.00, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'active', 1, 1, '2026-01-01 13:52:23', '2026-01-01 13:52:23');
...
(4, 9, '10', NULL, 'active', '2026-01-01 13:42:19', '2026-01-01 13:42:19');
...
(2, 2, 'uploads/textbooks/9/textbook_2_1767271944_0.jpg', 0, 0, '2026-01-01 13:52:24'),
(3, 2, 'uploads/textbooks/9/textbook_2_1767271944_1.jpg', 1, 0, '2026-01-01 13:52:24'),
(4, 2, 'uploads/textbooks/9/textbook_2_1767271944_2.jpg', 2, 0, '2026-01-01 13:52:24'),
(5, 2, 'uploads/textbooks/9/textbook_2_1767271944_3.jpg', 3, 0, '2026-01-01 13:52:24');
...
(3, 9, 'Abhinav', NULL, 'active', '2026-01-01 13:41:33', '2026-01-01 13:41:33');
...
(3, 9, 'Maths', NULL, 'active', '2026-01-01 13:42:31', '2026-01-01 13:42:31');
...
(5, 9, 'Drawing book', NULL, 'active', '2026-01-01 13:40:50', '2026-01-01 13:40:50'),
(6, 9, 'Guide', NULL, 'active', '2026-01-01 13:41:16', '2026-01-01 13:41:16');
...
(1, 'Book Store', NULL, '#007bff', '#6c757d', '© 2024 All rights reserved.', 1, 1, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-02 07:30:36', '2026-01-02 07:30:36');
...
INSERT INTO `vendor_features` (`id`, `feature_id`, `feature_slug`, `feature_name`, `is_enabled`, `synced_at`) VALUES
(1, 1, 'bookset', 'Bookset', 1, '2026-01-01 12:46:18'),
(2, 3, 'uniforms', 'Uniforms', 0, '2026-01-01 12:46:18'),
(3, 4, 'stationery', 'Stationery', 0, '2026-01-01 12:46:18'),
(4, 5, 'bags', 'Bags', 0, '2026-01-01 12:46:18'),
(5, 6, 'sports', 'Sports', 0, '2026-01-01 12:46:18'),
(6, 11, 'textbook', 'textbook', 1, '2026-01-01 12:46:18'),
(7, 12, 'notebooks', 'notebooks', 1, '2026-01-01 12:46:18');
