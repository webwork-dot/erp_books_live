...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('erp-admin/users'); ?>"><i class="isax isax-arrow-left me-2"></i>Add New User</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php echo form_open('erp-admin/users/add'); ?>
					<div class="row gx-3">
						...
						<div class="col-lg-6 col-md-6">
							<div class="mb-3">
								...
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" name="status" id="status" value="1" <?php echo set_checkbox('status', '1', TRUE); ?>>
