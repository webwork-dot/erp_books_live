<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <div>
        <h6><a href="<?php echo base_url('erp-admin/pos-agents'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit POS Agent</a></h6>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        ?>
        <?php echo form_open('erp-admin/pos-agents/edit/' . $agent['id']); ?>
            <div class="row gx-3">
                            ...
                            <table class="table table-sm table-bordered align-middle">
                                ...
                                <tbody>
                                    <?php foreach ($schools as $school): ?>
                                        <?php $sid = (int)$school['id']; $is_assigned = isset($mapped_schools[$sid]); ?>
                                        <tr>
                                            <td><input type="checkbox" name="school_ids[]" value="<?php echo $sid; ?>" <?php echo $is_assigned ? 'checked' : ''; ?>></td>
                                            <td><?php echo htmlspecialchars($school['school_name']); ?></td>
                                            <td><input type="checkbox" name="category_uniform[<?php echo $sid; ?>]" value="1" <?php echo ($is_assigned && (int)$mapped_schools[$sid]['can_uniform'] === 1) ? 'checked' : ''; ?>></td>
                                            <td><input type="checkbox" name="category_bookset[<?php echo $sid; ?>]" value="1" <?php echo ($is_assigned && (int)$mapped_schools[$sid]['can_bookset'] === 1) ? 'checked' : ''; ?>></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
