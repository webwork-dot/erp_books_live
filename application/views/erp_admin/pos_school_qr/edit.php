<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <div>
        <h6><a href="<?php echo base_url('erp-admin/pos-school-qr'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit School UPI QR</a></h6>
    </div>
</div>

<div class="card">
    <div class="card-body">
        <?php echo form_open_multipart('erp-admin/pos-school-qr/edit/' . $qr['id']); ?>
            <div class="row gx-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="upi_id" class="form-control" value="<?php echo set_value('upi_id', (string)$qr['upi_id']); ?>" maxlength="120">
                </div>
                <div class="col-md-6 mb-3">
