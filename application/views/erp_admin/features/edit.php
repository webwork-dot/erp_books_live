...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('erp-admin/features'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Feature</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				echo form_open('erp-admin/features/edit/' . $feature['id']);
					...
					<div class="row gx-3">
						<div class="col-lg-6 col-md-6">
							<div class="mb-3">
								...
								<input type="text" name="name" id="name" class="form-control" value="<?php echo set_value('name', $feature['name']); ?>" required>
						...
						<div class="col-lg-6 col-md-6">
							<div class="mb-3">
								...
								<input type="text" name="slug" id="slug" class="form-control" value="<?php echo set_value('slug', $feature['slug']); ?>" required>
						...
						<div class="col-12">
							<div class="mb-3">
								...
								<textarea name="description" id="description" class="form-control" rows="4"><?php echo set_value('description', $feature['description']); ?></textarea>
								...
								<select name="parent_id" id="parent_id" class="select">
									...
									<?php if (!empty($main_categories)): ?>
										<?php foreach ($main_categories as $category): ?>
											<?php if ($category['id'] != $feature['id']): ?>
												<option value="<?php echo $category['id']; ?>" <?php echo set_select('parent_id', $category['id'], (isset($feature['parent_id']) && $feature['parent_id'] == $category['id'])); ?>>
						...
						<div class="col-lg-6 col-md-6">
							<div class="mb-3">
								...
								<select name="is_active" id="is_active" class="select" required>
									...
									<option value="1" <?php echo set_select('is_active', '1', $feature['is_active'] == 1); ?>>Active</option>
									<option value="0" <?php echo set_select('is_active', '0', $feature['is_active'] == 0); ?>>Inactive</option>
								</select>
						...
						<div class="col-lg-6 col-md-6">
							<div class="mb-3">
								...
								<select name="is_school" id="is_school" class="select">
									<option value="0" <?php echo set_select('is_school', '0', (isset($feature['is_school']) && $feature['is_school'] == 0)); ?>>No</option>
									<option value="1" <?php echo set_select('is_school', '1', (isset($feature['is_school']) && $feature['is_school'] == 1)); ?>>Yes</option>
								</select>
						...
						<div class="col-lg-4 col-md-4">
							<div class="mb-3">
								...
								<select name="has_variations" id="has_variations" class="select">
									<option value="0" <?php echo set_select('has_variations', '0', (!isset($feature['has_variations']) || $feature['has_variations'] == 0)); ?>>No</option>
									<option value="1" <?php echo set_select('has_variations', '1', (isset($feature['has_variations']) && $feature['has_variations'] == 1)); ?>>Yes</option>
								</select>
						...
						<div class="col-lg-4 col-md-4">
							<div class="mb-3">
								...
								<select name="has_size" id="has_size" class="select">
									<option value="0" <?php echo set_select('has_size', '0', (!isset($feature['has_size']) || $feature['has_size'] == 0)); ?>>No</option>
									<option value="1" <?php echo set_select('has_size', '1', (isset($feature['has_size']) && $feature['has_size'] == 1)); ?>>Yes</option>
								</select>
						...
						<div class="col-lg-4 col-md-4">
							<div class="mb-3">
								...
								<select name="has_colour" id="has_colour" class="select">
									<option value="0" <?php echo set_select('has_colour', '0', (!isset($feature['has_colour']) || $feature['has_colour'] == 0)); ?>>No</option>
									<option value="1" <?php echo set_select('has_colour', '1', (isset($feature['has_colour']) && $feature['has_colour'] == 1)); ?>>Yes</option>
								</select>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	var originalSlug = '<?php echo htmlspecialchars($feature['slug'], ENT_QUOTES); ?>';
	var featureId = <?php echo $feature['id']; ?>;
	...
	function checkSlugUniqueness(slug) {
		...
		// If slug is same as original, no need to check
		...
		checkSlugTimeout = setTimeout(function() {
			...
			xhr.open('GET', '<?php echo base_url('erp-admin/features/check_slug/'); ?>' + encodeURIComponent(slug) + '/' + featureId, true);
