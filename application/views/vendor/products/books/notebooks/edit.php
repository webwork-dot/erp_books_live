...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/notebooks'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Notebook</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
		...
		<div class="card">
			<div class="card-body">
				...
				<?php endif; ?>
					...
					<!-- Basic Information -->
					<div class="row gx-3">
						<!-- Type field removed: notebook type is implied by URL /products/notebooks/edit/{id} -->
...
function deleteImage(imageId) {
	...
	fetch('<?php echo base_url('products/notebooks/delete_image/'); ?>' + imageId, {
		method: 'POST',
		headers: {
