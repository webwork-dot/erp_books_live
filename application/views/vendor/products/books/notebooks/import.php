...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/notebooks'); ?>"><i class="isax isax-arrow-left me-2"></i>Bulk Import Notebooks</a></h6>
	</div>
	<div class="d-flex gap-2">
		<a href="<?php echo base_url('products/notebooks/import/template'); ?>" class="btn btn-outline-primary">
			<i class="isax isax-document-download"></i> Download Template
		</a>
		<a href="<?php echo base_url('products/notebooks'); ?>" class="btn btn-outline-secondary">Back to List</a>
	</div>
</div>
<!-- End Breadcrumb -->
	...
	<div class="col-lg-8">
		<div class="card mb-3">
			<div class="card-body">
				...
				<?php echo form_open_multipart(base_url('products/notebooks/import')); ?>
					<div class="mb-3">
					...
					<button type="submit" class="btn btn-primary">
						<i class="isax isax-import"></i> Import Notebooks
					</button>
				<?php echo form_close(); ?>
			</div>
		</div>
	...
	<div class="col-lg-4">
		<div class="card mb-3">
			<div class="card-body">
				...
				<ul class="mb-0 ps-3">
					<li class="mb-2">Download the template and fill the <strong>Notebooks</strong> sheet.</li>
					<li class="mb-2">Use the <strong>dropdown arrows</strong> on Brand, Binding Type, Status, etc. (rows 2–501).</li>
					<li class="mb-2">Reference sheets list valid brand and type names.</li>
					<li class="mb-2">Provide at least <strong>ISBN</strong> or <strong>SKU</strong> for duplicate detection.</li>
					<li class="mb-2">Binding types: <code>center_binding</code>, <code>perfect_binding</code>, <code>spiral_binding</code>.</li>
					<li>If ISBN/SKU already exists, the row will <strong>update</strong> that product.</li>
				</ul>
			</div>
		</div>
	</div>
