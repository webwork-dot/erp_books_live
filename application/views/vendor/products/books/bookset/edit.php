...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url(isset($current_vendor['domain']) ? $current_vendor['domain'] . '/products/bookset?tab=with_product' : 'products/bookset?tab=with_product'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Bookset</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
...
<?php echo form_open(isset($current_vendor['domain']) ? base_url($current_vendor['domain'] . '/products/bookset/edit/' . $bookset['id']) : base_url('products/bookset/edit/' . $bookset['id']), array('id' => 'bookset-with-products-form')); ?>
...
(function() {
	function initScript() {
		...
		function loadProductsForPackage(packageId, category, existingProducts) {
			...
			$.ajax({
				url: '<?php echo base_url(isset($current_vendor["domain"]) ? $current_vendor["domain"] . "/products/bookset/package/get_products_by_type" : "products/bookset/package/get_products_by_type"); ?>',
				type: 'GET',
				data: {
					category: category
				},
