...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url(isset($current_vendor['domain']) ? $current_vendor['domain'] . '/products/bookset?tab=with_product' : 'products/bookset?tab=with_product'); ?>"><i class="isax isax-arrow-left me-2"></i>Add Bookset with Products</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
