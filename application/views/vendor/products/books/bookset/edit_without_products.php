...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/bookset?tab=without_product' : 'products/bookset?tab=without_product'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Bookset</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
