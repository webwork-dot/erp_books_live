...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/textbook'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Textbook</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
...
function deleteImage(imageId) {
	...
	fetch('<?php echo base_url('products/textbook/delete_image/'); ?>' + imageId, {
		method: 'POST',
		headers: {
