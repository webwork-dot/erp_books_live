...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/individual-products' : 'products/individual-products'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Individual Product</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
