...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url('products/individual-products'); ?>"><i class="isax isax-arrow-left me-2"></i>Edit Individual Product</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
								...
								<?php if (isset($product_images) && !empty($product_images)): ?>
									...
									<?php foreach ($product_images as $img): ?>
										...
										<div class="image-preview-item existing-image" data-image-id="<?php echo $img['id']; ?>" style="position: relative; display: inline-block; margin: 3px; cursor: move; vertical-align: top;">
											<img src="<?php echo $image_url; ?>" alt="Product Image" style="width: 120px; height: 120px; object-fit: cover; border: 2px solid #ddd; border-radius: 4px 4px 0 0; display: block;" onerror="this.onerror=null; this.src='<?php echo base_url('assets/template/img/placeholder-image.png'); ?>'">
				...
				<div class="row gx-3">
					...
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="number" name="selling_price" id="selling_price" class="form-control" form="individual-product-form" value="<?php echo set_value('selling_price', isset($product['selling_price']) ? $product['selling_price'] : ''); ?>" step="0.01" min="0" required>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	function attachEventHandlers() {
		if (typeof $ !== 'undefined' && $.fn.select2) {
			...
			setTimeout(function() {
				loadSubcategories(
					<?php echo (int) $selected_category_id; ?>,
					<?php echo json_encode(isset($selected_subcategory_id) ? (string) $selected_subcategory_id : ''); ?>
				);
			}, 500);
			<?php endif; ?>
