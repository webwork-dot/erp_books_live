...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url(isset($current_vendor['domain']) ? $current_vendor['domain'] . '/products/individual-products' : 'products/individual-products'); ?>"><i class="isax isax-arrow-left me-2"></i>Add New Individual Product</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
<?php echo form_open_multipart(isset($current_vendor['domain']) ? base_url($current_vendor['domain'] . '/products/individual-products/save') : base_url('products/individual-products/save'), array('id' => 'individual-product-form')); ?>
