...
<!-- End Breadcrumb -->
<?php echo form_open_multipart(base_url('products/individual-products/save'), array('id' => 'individual-product-form')); ?>
				...
				<div class="row gx-3">
					<div class="col-12">
						<div class="mb-3">
							...
							<input type="file" name="images[]" id="images" class="form-control" form="individual-product-form" accept="image/*" multiple required>
					...
					<div class="col-lg-12">
						<div class="mb-2">
							...
							<div class="input-group">
								...
								<a href="<?php echo base_url('products/variations'); ?>" class="btn btn-outline-primary btn-sm" target="_blank" style="padding: 0.4rem 0.8rem;">
									<i class="isax isax-setting-2"></i> Manage
								</a>
							</div>
							<small class="text-muted fs-12">Select variation types (e.g., Size, Color, Material). Leave empty for no variations. <a href="<?php echo base_url('products/variations'); ?>" target="_blank">Manage variation types</a></small>
						</div>
					</div>
				</div>
				...
				<div class="row gx-3">
					...
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="text" name="display_name" id="display_name" class="form-control" value="<?php echo set_value('display_name'); ?>">
					...
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="text" name="sku" id="sku" class="form-control" value="<?php echo set_value('sku'); ?>">
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
					...
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="text" name="product_origin" id="product_origin" class="form-control" value="<?php echo set_value('product_origin'); ?>" required>
				...
				<div class="row gx-3">
					<div class="col-lg-3 col-md-6">
						<div class="mb-3">
							...
							<input type="number" name="packaging_length" id="packaging_length" class="form-control" form="individual-product-form" value="<?php echo set_value('packaging_length'); ?>" step="0.01" min="0">
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="mb-3">
							<label class="form-label">Width (in cm)</label>
							<input type="number" name="packaging_width" id="packaging_width" class="form-control" form="individual-product-form" value="<?php echo set_value('packaging_width'); ?>" step="0.01" min="0">
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="mb-3">
							<label class="form-label">Height (in cm)</label>
							<input type="number" name="packaging_height" id="packaging_height" class="form-control" form="individual-product-form" value="<?php echo set_value('packaging_height'); ?>" step="0.01" min="0">
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="mb-3">
							<label class="form-label">Weight (in gm)</label>
							<input type="number" name="packaging_weight" id="packaging_weight" class="form-control" form="individual-product-form" value="<?php echo set_value('packaging_weight'); ?>" step="0.01" min="0">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row gx-3">
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="number" name="gst_percentage" id="gst_percentage" class="form-control" form="individual-product-form" value="<?php echo set_value('gst_percentage', 0); ?>" step="0.01" min="0" max="100" required>
					...
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="text" name="hsn" id="hsn" class="form-control" form="individual-product-form" value="<?php echo set_value('hsn'); ?>">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row gx-3">
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							...
							<input type="number" name="mrp" id="mrp" class="form-control" form="individual-product-form" value="<?php echo set_value('mrp'); ?>" step="0.01" min="0" required>
				...
				<div class="row gx-3">
					<div class="col-12">
						<div class="mb-3">
							...
							<input type="text" name="meta_title" id="meta_title" class="form-control" form="individual-product-form" value="<?php echo set_value('meta_title'); ?>">
						</div>
					</div>
					<div class="col-12">
						<div class="mb-3">
							<label class="form-label">Meta Keywords</label>
							<textarea name="meta_keywords" id="meta_keywords" class="form-control" form="individual-product-form" rows="3"><?php echo set_value('meta_keywords'); ?></textarea>
						</div>
					</div>
					<div class="col-12">
						<div class="mb-3">
							<label class="form-label">Meta Description</label>
							<textarea name="meta_description" id="meta_description" class="form-control" form="individual-product-form" rows="3"><?php echo set_value('meta_description'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
...
function renderPricingMatrix(combinations) {
	...
	html += '<div class="mt-3"><button type="button" class="btn btn-sm btn-outline-primary" onclick="bulkSetPrices()">Bulk Set Prices</button></div>';
...
document.addEventListener('DOMContentLoaded', function() {
	...
	function attachEventHandlers() {
		if (typeof $ !== 'undefined' && $.fn.select2) {
			...
			// Trigger variation type change to set initial state
			setTimeout(function() {
				handleVariationTypeChange();
			}, 300);
