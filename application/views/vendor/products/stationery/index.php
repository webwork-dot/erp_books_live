...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	...
	<div class="d-flex gap-2">
		<a href="<?php echo base_url('products/stationery/import'); ?>" class="btn btn-outline-primary">
			<i class="isax isax-import"></i> Bulk Import
		</a>
		<a href="<?php echo base_url('products/stationery/add'); ?>" class="btn btn-primary">
...
<div class="card mb-3">
	<div class="card-body">
		<form method="get" action="<?php echo base_url('products/stationery'); ?>">
			<div class="row gx-3">
				...
				<?php if (!empty($stationery_list)): ?>
					<?php $sr_no = (($current_page - 1) * $per_page) + 1; foreach ($stationery_list as $stationery): ?>
						<tr>
							...
							<td class="text-end">
								<a href="<?php echo base_url('products/stationery/edit/' . $stationery['id']); ?>" class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Edit">
									<i class="isax isax-edit"></i>
								</a>
								<a href="<?php echo base_url('products/stationery/delete/' . $stationery['id']); ?>" onclick="return confirm('Are you sure you want to delete this stationery?');" class="btn btn-sm btn-outline-danger" data-bs-toggle="tooltip" title="Delete">
					...
					<nav aria-label="Page navigation">
						<ul class="pagination pagination-sm mb-0">
							<?php if ($current_page > 1): ?>
								<li class="page-item">
									<a class="page-link" href="<?php echo base_url('products/stationery?' . http_build_query(array_merge($filters, array('page' => $current_page - 1)))); ?>">Previous</a>
								</li>
							<?php else: ?>
							...
							<?php for ($i = 1; $i <= $total_pages; $i++): ?>
								...
								<?php else: ?>
									<li class="page-item">
										<a class="page-link" href="<?php echo base_url('products/stationery?' . http_build_query(array_merge($filters, array('page' => $i)))); ?>"><?php echo $i; ?></a>
									</li>
								<?php endif; ?>
							<?php endfor; ?>
							...
							<?php if ($current_page < $total_pages): ?>
								<li class="page-item">
									<a class="page-link" href="<?php echo base_url('products/stationery?' . http_build_query(array_merge($filters, array('page' => $current_page + 1)))); ?>">Next</a>
								</li>
							<?php else: ?>
								<li class="page-item disabled">
