...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
	<div>
		<h6><a href="<?php echo base_url(isset($current_vendor['domain']) ? $current_vendor['domain'] . '/products/stationery' : 'products/stationery'); ?>"><i class="isax isax-arrow-left me-2"></i>Add New Stationery</a></h6>
	</div>
</div>
<!-- End Breadcrumb -->
<?php echo form_open_multipart(isset($current_vendor['domain']) ? base_url($current_vendor['domain'] . '/products/stationery/add') : base_url('products/stationery/add'), array('id' => 'stationery-form')); ?>
