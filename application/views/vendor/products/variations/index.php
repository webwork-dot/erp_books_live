...
function loadValuesDisplay(typeId) {
	fetch('<?php echo base_url("products/variations/get_values"); ?>?type_id=' + typeId)
...
function addVariationType() {
	...
	fetch('<?php echo base_url("products/variations/add_type"); ?>', {
		method: 'POST',
		body: formData
	})
	.then(response => response.json())
...
function updateVariationType() {
	...
	fetch('<?php echo base_url("products/variations/update_type/"); ?>' + id, {
		method: 'POST',
		body: formData
	})
	.then(response => response.json())
...
function addVariationValues() {
	...
	fetch('<?php echo base_url("products/variations/add_value"); ?>', {
		method: 'POST',
		body: formData
	})
		.then(response => response.json())
...
function deleteValueConfirmed(valueId, typeId) {
	...
	fetch('<?php echo base_url("products/variations/delete_value/"); ?>' + valueId, {
		method: 'POST'
	})
	.then(response => response.json())
	.then(data => {
