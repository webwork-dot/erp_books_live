...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .box .lbl { font-size: 10px; font-weight: bold; display: block; margin-bottom: 4px; }
        .muted { color: #666; }
            ...
            <tr>
                <td style="width:55%; vertical-align:top; word-wrap: break-word;">
                    ...
                    <?php if (!empty($logo_src)): ?>
                        <img src="<?php echo htmlspecialchars($logo_src); ?>" alt="Logo" class="logo" style="max-width: 200px; max-height: 80px; width: auto; height: auto;" onerror="this.style.display='none';">
                    <?php endif; ?>
                </td>
                <td style="width:45%; vertical-align:top;" class="right">
                    <div class="small">
                        <div><strong>Shipping No:</strong> <b  style="color: red; font-size: 16px;"><?php echo htmlspecialchars($shipping_number); ?></b></div>
                        <div><strong>Generated On:</strong> <b style="color: red; font-size: 16px;"><?php echo date('d M, Y h:i A'); ?></b></div>
            ...
            <tr>
                <td style="width:50%; padding-right:10px; vertical-align:top; word-wrap: break-word; overflow-wrap: break-word;">
                    <div class="section">
                        ...
                        <?php if ($address): ?>
                            <div style="word-wrap: break-word;"> <strong>Name: </strong><?php echo htmlspecialchars($address->name); ?></div>
                            <div> <strong>Mobile: </strong> <?php echo htmlspecialchars($address->mobile_no); ?></div>
                            <div style="word-wrap: break-word;"> <strong>Address: </strong> <?php echo htmlspecialchars($address->address); ?></div>
                            <div> <strong>City: </strong> <?php echo htmlspecialchars($address->city); ?>, <?php echo htmlspecialchars($address->state); ?> </div>
                            <div> <strong>Pincode: </strong> <?php echo htmlspecialchars($address->pincode); ?></div>
                            <?php if (!empty($address->landmark)): ?>
                                <div style="word-wrap: break-word;"> <strong>Landmark: </strong> <?php echo htmlspecialchars($address->landmark); ?></div>
                            <?php endif; ?>
                        <?php else: ?>
