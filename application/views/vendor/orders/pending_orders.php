...
<div class="mobile_view home">
   ...
   <div class="row mb-3">
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               <form method="get" action="<?php echo base_url($vendor_domain . '/orders/pending-orders'); ?>" class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                     ...
                     <div>
                        ...
                        <a href="<?php echo base_url($vendor_domain . '/orders/pending-orders'); ?>" class="btn btn-secondary">Clear</a>
                     </div>
                  </div>
               </form>
            </div>
