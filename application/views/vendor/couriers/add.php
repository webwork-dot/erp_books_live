...
<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-2 mb-2">
	<div>
		<h6 class="mb-0 fs-14">Add New Courier</h6>
	</div>
	<div>
...
<?php echo form_open(base_url('couriers/add'), array('id' => 'courierForm')); ?>
			...
			<div class="card-body">
				<div class="row g-3">
					<div class="col-md-6">
						...
						<input type="text" name="courier_name" class="form-control" value="<?php echo set_value('courier_name'); ?>" required maxlength="150" placeholder="e.g. Blue Dart, DTDC">
						<?php echo form_error('courier_name', '<div class="text-danger fs-12 mt-1">', '</div>'); ?>
					</div>
					<div class="col-md-6">
						<label class="form-label">Tracking Link</label>
						<input type="url" name="tracking_link" class="form-control" value="<?php echo set_value('tracking_link'); ?>" maxlength="255" placeholder="https://tracking.example.com/">
...
<div class="d-flex gap-2">
	<button type="submit" class="btn btn-primary">
		<i class="isax isax-tick-circle me-1"></i>Add Courier
	</button>
