					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="mb-2">
							...
							<select name="color" id="color" class="form-control form-control-sm select2-color"
								...
								<option value="Vayu" <?php echo set_select('color', 'Vayu'); ?>>Vayu</option>
								<option value="Jal" <?php echo set_select('color', 'Jal'); ?>>Jal</option>
								<option value="Agni" <?php echo set_select('color', 'Agni'); ?>>Agni</option>
								<option value="Prithvi" <?php echo set_select('color', 'Prithvi'); ?>>Prithvi</option>
							</select>
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-md-6">
