						...
						<div class="mb-2">
							...
							<div class="input-group">
								<select name="class_ids[]" id="class_ids" class="form-control form-control-sm select2"
									multiple data-placeholder="Select Classes">
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="mb-2">
							...
							<select name="gender" id="gender" class="form-select form-select-sm">
								...
								<option value="male" <?php echo ($uniform['gender'] == 'male') ? 'selected' : ''; ?>>Male
								</option>
								<option value="female" <?php echo ($uniform['gender'] == 'female') ? 'selected' : ''; ?>>
									Female</option>
								<option value="unisex" <?php echo ($uniform['gender'] == 'unisex') ? 'selected' : ''; ?>>
									Unisex</option>
							</select>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="mb-2">
							...
							<select name="color" id="color" class="form-control form-control-sm select2-color"
								...
								<option value="Tan" <?php echo set_select('color', 'Tan', $uniform['color'] == 'Tan'); ?>>
									Tan</option>
