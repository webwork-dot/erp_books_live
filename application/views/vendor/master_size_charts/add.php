...
<div class="card shadow-sm border-0">
	<div class="card-body">
		<form id="master-size-chart-form" method="post" action="<?php echo base_url('master-size-charts/add'); ?>">
			<input type="hidden"
			...
			<div class="row">
				<div class="col-md-8">
					<div class="mb-3">
						...
						<input type="text" name="chart_name" class="form-control" placeholder="e.g. Boys Shirt Size Chart" required value="<?php echo set_value('chart_name'); ?>">
