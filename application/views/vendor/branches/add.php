			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						...
						<input type="text" name="branch_name" class="form-control" value="<?php echo set_value('branch_name'); ?>" required>
					...
					<div class="col-md-4 mb-3">
						...
						<input type="text" name="pincode" class="form-control" value="<?php echo set_value('pincode'); ?>" maxlength="10" required>
