				...
				<div class="row g-2">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 mb-2 d-flex align-items-end">
						<div class="form-check form-switch mb-2">
							<input class="form-check-input border-primary" type="checkbox" name="is_private_bookset" id="is_private_bookset" value="1" <?php echo set_checkbox('is_private_bookset', '1'); ?>>
