			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" name="school_name" class="form-control" value="<?php echo set_value('school_name', $school['school_name']); ?>" required>
					...
					<div class="col-md-6 mb-3">
						...
						<input type="number" name="total_strength" class="form-control" value="<?php echo set_value('total_strength', $school['total_strength']); ?>" min="0">
						<?php echo form_error('total_strength', '<div class="text-danger fs-13 mt-1">', '</div>'); ?>
					</div>
					
					<div class="col-md-6 mb-3">
						<label class="form-label">Affiliation No.</label>
						<input type="text" name="affiliation_no" class="form-control" value="<?php echo set_value('affiliation_no', $school['affiliation_no']); ?>">
					...
					<div class="col-md-12 mb-3">
						...
						<textarea name="school_description" class="form-control" rows="4" required><?php echo set_value('school_description', $school['school_description']); ?></textarea>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12 mb-3">
						...
						<textarea name="address" class="form-control" rows="3" required><?php echo set_value('address', $school['address']); ?></textarea>
					...
					<div class="col-md-4 mb-3">
						...
						<input type="text" name="pincode" class="form-control" value="<?php echo set_value('pincode', $school['pincode']); ?>" pattern="[0-9]{6}" maxlength="10" required>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-4 mb-3">
						...
						<input type="text" name="admin_name" class="form-control" value="<?php echo set_value('admin_name', $school['admin_name']); ?>" required>
					...
					<div class="col-md-4 mb-3">
						...
						<input type="text" name="admin_phone" class="form-control" value="<?php echo set_value('admin_phone', $school['admin_phone']); ?>" required>
					...
					<div class="col-md-4 mb-3">
						...
						<input type="email" name="admin_email" class="form-control" value="<?php echo set_value('admin_email', $school['admin_email']); ?>" required>
					...
					<div class="col-md-12 mb-3">
						...
						<div class="position-relative">
							<input type="password" name="admin_password" id="admin_password" class="form-control" minlength="6" placeholder="Leave blank to keep current password">
					...
					<div class="row mb-3">
						<?php foreach ($school_images as $image): ?>
							<div class="col-md-3 mb-3">
								<div class="position-relative">
									<img src="<?php echo base_url('uploads/schools/' . $image['image_path']); ?>" class="img-thumbnail" style="width: 100%; height: 200px; object-fit: cover;">
									<?php if ($image['is_primary']): ?>
										<span class="badge badge-success position-absolute top-0 start-0 m-2">Primary</span>
									<?php endif; ?>
									<a href="<?php echo base_url($vendor_domain . '/schools/delete_image/' . $image['id']); ?>" class="btn btn-sm btn-danger position-absolute top-0 end-0 m-2" onclick="return confirm('Are you sure you want to delete this image?');">
