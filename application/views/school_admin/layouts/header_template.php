...
<head>
	...
	<title><?php echo isset($title) ? htmlspecialchars($title) . ' | ' : ''; ?>School Admin Dashboard</title>
		...
		<div class="header">
			<div class="main-header">
				<div class="header-left">
					...
					?>
					<a href="<?php echo base_url('school-admin/dashboard'); ?>" class="logo">
						<img src="<?php echo $logo_url; ?>" alt="Logo" onerror="this.src='<?php echo $logo_fallback; ?>'">
					</a>
					<a href="<?php echo base_url('school-admin/dashboard'); ?>" class="dark-logo">
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrumb-divide mb-0">
									<li class="breadcrumb-item d-flex align-items-center">
										<a href="<?php echo base_url('school-admin/dashboard'); ?>">
									...
									<?php if (isset($breadcrumb) && is_array($breadcrumb)): ?>
										<?php foreach ($breadcrumb as $item): ?>
											<li class="breadcrumb-item <?php echo isset($item['active']) && $item['active'] ? 'active' : ''; ?>" <?php echo isset($item['active']) && $item['active'] ? 'aria-current="page"' : ''; ?>>
												...
												<?php else: ?>
													<a href="<?php echo base_url(isset($item['url']) ? $item['url'] : '#'); ?>"><?php echo htmlspecialchars($item['label']); ?></a>
												<?php endif; ?>
											</li>
										<?php endforeach; ?>
									<?php else: ?>
							...
							<div class="dropdown profile-dropdown">
								<a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" data-bs-auto-close="outside">
									...
									<span class="ms-2 d-none d-md-block">
										<span class="d-block fw-semibold"><?php echo isset($current_vendor['name']) ? htmlspecialchars($current_vendor['name']) : 'School'; ?></span>
								...
								<div class="dropdown-menu dropdown-menu-end p-2">
									<a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('school-admin/auth/logout'); ?>">
