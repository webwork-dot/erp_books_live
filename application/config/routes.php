...
$route['app/agent/stock_summary'] = 'App_api/get_stock_summary';
$route['app/agent/sold_stock_summary'] = 'App_api/get_sold_stock_summary';
...
$route['app/agent/pos_sale_deduct'] = 'App_api/pos_sale_deduct';
...
$route['schools/qr_preview/(:num)/(:num)'] = 'Vendor/schools/qr_preview/$1/$2';
$route['schools/qr_preview/(:num)'] = 'Vendor/schools/qr_preview/$1';
$route['schools/branch_qr_preview/(:num)/(:num)'] = 'Vendor/schools/branch_qr_preview/$1/$2';
$route['schools/branch_qr_preview/(:num)'] = 'Vendor/schools/branch_qr_preview/$1';
$route['schools/download_qr/(:num)/(:num)'] = 'Vendor/schools/download_qr/$1/$2';
$route['schools/download_qr/(:num)'] = 'Vendor/schools/download_qr/$1';
$route['schools/download_branch_qr/(:num)/(:num)'] = 'Vendor/schools/download_branch_qr/$1/$2';
$route['schools/download_branch_qr/(:num)'] = 'Vendor/schools/download_branch_qr/$1';
...
$route['branches/get_branch_details/(:num)'] = 'Vendor/branches/get_branch_details/$1';
...
$route['orders/failed-payment'] = 'Vendor/orders/pending_orders';
$route['orders/mark_as_success'] = 'Vendor/orders/mark_as_success';
...
$route['orders/bulk_save_third_party_shipping'] = 'Vendor/orders/bulk_save_third_party_shipping';
...
$route['cron/shiprocket_token/(:any)'] = 'cron/shiprocket_token/$1';
...
$route['products/uniforms/edit_class'] = 'Vendor/uniforms/edit_class';
$route['products/uniforms/add_house'] = 'Vendor/uniforms/add_house';
$route['products/uniforms/edit_house'] = 'Vendor/uniforms/edit_house';
$route['products/uniforms/get_houses'] = 'Vendor/uniforms/get_houses';
...
$route['products/individual-products/update_category'] = 'Vendor/products/individual_products_update_category';
$route['products/individual-products/get_category'] = 'Vendor/products/individual_products_get_category';
